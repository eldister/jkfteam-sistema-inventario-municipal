...
public class ManejadorReparacion implements IReporteador{
     ...
     * es para obtener información de la base de datos utilizando los parametros
    ...
    public ArrayList<String[]> obtenerDatosReporte(Date fini, Date ffin) {
        ArrayList<String[]> resp = new ArrayList<String[]>();
        ManejadorDatosReparacion mproveedor = new ManejadorDatosReparacion();
        try {
            ResultSet rs = mproveedor.ReporteGeneralReparaciones(fini, ffin);
            ResultSetMetaData rsmd = rs.getMetaData();
