<%
    request.setAttribute("permiso_requerido", 12);
%>
...
<%
    ...
    try {
        ...
        if (respuesta != null && configuracion != null) {
            proceso = true;
        }
         if (proceso) {
...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        ...
        <script src='<%=request.getContextPath()%>/js/script_paginas/script_nuevo_configuracion.js' charset="utf-8"></script>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <form id="formulario" class="form" method="POST" action="<%out.print(Recursos.Servers.MAINSERVER);%>/configuracion?proceso=nuevo_cr">
                    ...
                    <table id="sm_tb_campos">
                        ...
                        <tr id="sm_contenedor_controles">
                            <td class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
                                    <input type="submit" value="Registrar Configuración" class="form-control btn-info">
                                </div>
                            </td>
                            <td  class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
