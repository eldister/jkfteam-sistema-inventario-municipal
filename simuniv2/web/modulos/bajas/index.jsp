<%
    request.setAttribute("permiso_requerido", 8);
%>
<%@page import="simuni.enums.Recursos"%>
<%@page import="java.sql.ResultSet"%>
<%@page import="simuni.clases.ui.MostradorBaja"%>
<%@page import="simuni.utils.UtilidadesServlet"%>
<%@ page language='java' contentType='text/html; charset=ISO-8859-1' pageEncoding='ISO-8859-1'%>
<%@ taglib prefix='decorator' uri='http://claudiushauptmann.com/jsp-decorator/'%>
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Mantenimientos - Bajas </decorator:content>    
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        ...
        <script src='<%=request.getContextPath()%>/js/script_paginas/script_modulo_bajaindex.js' charset="utf-8"></script>
    </decorator:content>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <%
            ...
            out.write(new MostradorBaja().Renderizar(listado, paginacion));
        %>
