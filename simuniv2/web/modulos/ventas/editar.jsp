...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        <script src="<%=request.getContextPath()%>/js/script_paginas/script_editar_venta.js" charset="utf-8"></script>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        ...
        <form class="form"  id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/venta?proceso=actualizar" method="POST">
            <fieldset id="activos">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group" id="sm_contenedor_activoarticulo">
                                                ...
                                                <input type="hidden" id="sm_hidden_codigoventa" name="hddventa" value="<%out.print((venta != null) ? venta.getCodigoVenta() : "");%>">                                           
                                            </div>
                                        </td>                                             
                                        <td>
