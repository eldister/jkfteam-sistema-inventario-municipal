<%
    request.setAttribute("permiso_requerido", 49);
%>
...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        ...
        <form class="form"  id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/venta?proceso=nuevo" method="POST">
            <fieldset id="activos">
                    ...
                    <table id="sm_tb_campos">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group" id="sm_contenedor_activoarticulo">
                                                ...
                                                <label id="lbl_inforactivo"><%out.print((venta != null) ? ((Venta) venta).getPlacaActivo() + "Seleccionado" : "No seleccionado");%></label>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="<%out.print((venta != null) ? (venta).getFechaVenta() : "");%>" required="required" class="form-control" name="txtfechaventa" id="txtfechaventa" placeholder="12-05-2014">
                                            </div>
                                        </td>  
                                        <td>
                                            <div class="form-group">
                                                <label  class="control-label"for="txtfactura">Consecutivo de Factura</label>
                                                <input type="text" required="required" value="<%out.print((venta != null) ? (venta).getCodigoFactura(): "");%>" class="form-control" name="txtfactura" id="txtfactura" placeholder="00001">
                                            </div>
                                        </td>                                            
                                    </tr>
                                    <tr> 
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="required" value="<%out.print((venta != null) ? (venta).getNombreComprador(): "");%>" class="form-control" name="txtnombrecomprador" id="txtnombrecomprador" placeholder="00001">
                                            </div>
                                        </td>                                              
                                        <td>
                                            <div class="form-group">
                                                <label  class="control-label" for="txtmontoventa">Monto de la Venta <small>*en colones</small></label>
                                                <input type="number" value="<%out.print((venta != null) ? (venta).getMontoVenta(): "");%>" required="required" class="form-control" name="txtmontoventa" id="txtmontoventa" placeholder="5000000">
                                            </div>
                                        </td>  
                                        <td>
                                            <div class="form-group">
                                                <label  class="control-label"for="cmbestadoventa">Estado de la Venta</label>
                                                <select class="form-control" required="required" name="cmbestadoventa">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" required="required" name="cmbtipopago" id="cmbtipopago">
                                                    <%
                                        ...
                                        <td colspan="2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="txtdireccioncomprador" id="txtdireccioncomprador" placeholder="Carmona, Nandayure"><%out.print((venta != null) ? venta.getDireccionComprador(): "");%></textarea>
                                            </div>
                                        </td>                                               
                                    </tr> 
                                    <tr>
                                        <td colspan="3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="txtobservaciones" id="txtobservaciones" placeholder="Ej. Activo de Segunda"><%out.print((venta != null) ? venta.getObservaciones() : "");%></textarea>
                                            </div>
                                        </td>                                               
                                    </tr>                                            
                                </table>                          
                        ...
                        <tr id="sm_contenedor_controles">
                            <td class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
                                    <input type="submit" value="Registrar Venta" class="form-control btn-info">
                                </div>
                            </td>
                            <td  class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
                            ...
                            <td id="btn_controles_procesocorrecto">
                                <input type="hidden" id="sm_hidden_codigoventa" value="<%out.print((venta != null) ? venta.getCodigoVenta() : "");%>">
                                <div class="form-group">
