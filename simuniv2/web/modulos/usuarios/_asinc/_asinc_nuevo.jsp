...
<%
    ...
    try {
        usuario = (Usuario) request.getAttribute("nuevoregistro");
        respuesta = (Respuesta) request.getAttribute("respuesta");
        if (respuesta != null && usuario != null) {
            proceso = true;
        }
        ...
        if (departamentos != null) {
            ...
            System.out.println("listo entree");
                        ...
                        System.out.println("listo noentree");
...
<form class="sm_div_formulario" method="POST" id="formulario_registro">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>" ><h4>Registro de Usuario <small> *(Los permisos se otorgan despues de este proceso)</small></h4> </legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input type="text" value="<%out.print((error && proceso && usuario != null) ? usuario.getCedula() : "");%>" class="form-control" name="txtcedulausuario" required="required" id="txtcedulausuario" placeholder="#-####-#####">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtnombre">Nombre </label>
                            <input type="text" value="<%out.print((error && proceso && usuario != null) ? usuario.getNombre() : "");%>" class="form-control" name="txtnombre"  id="txtnombre" placeholder="Ej. Juan">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtapellido1">1er Apellido</label>
                            <input type="text" value="<%out.print((error && proceso && usuario != null) ? usuario.getApellido1() : "");%>" class="form-control" name="txtapellido1"  id="txtapellido1" placeholder="Ej. Ramírez">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtapellido2">2do Apellido</label>
                            <input type="text" value="<%out.print((error && proceso && usuario != null) ? usuario.getApellido2() : "");%>" class="form-control" name="txtapellido2" id="txtapellido2" placeholder="Ej. Ramírez">
                        </div>
                    </td>                    
                </tr> 
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input type="email" value="<%out.print((error && proceso && usuario != null) ? usuario.getEmail(): "");%>" class="form-control" name="txtemail" id="txtemail" placeholder="Ej. ejemplo@ejemplo.com">
                        </div>
                    </td>                    
                    <td>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cmbdepartamento" required="required" id="cmbdepartamento">
                                ...
                                %>
                                <option <%out.print((error && proceso && usuario != null && usuario.getAreatrabajo() == depto.getIddepartamento()) ? "selected='selected'" : "");%> value="<%out.print(depto.getIddepartamento());%>"><%out.print(depto.getNombredepartamento());%></option>
                                <%
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cmbpuesto" required="required" id="cmbpuesto">
                                ...
                                %>
                                <option <%out.print((error && proceso && usuario != null && usuario.getCodigoPuesto()== puesto.getCodigoPuesto()) ? "selected='selected'" : "");%> value="<%out.print(puesto.getCodigoPuesto());%>"><%out.print(puesto.getNombrePuesto());%></option>
                                <%
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cmbtipousuario" required="required" id="cmbtipousuario">
                                ...
                                %>
                                <option <%out.print((error && proceso && usuario != null && usuario.getTipousuario()== tipousuario.getIdtipousuario()) ? "selected='selected'" : "");%> value="<%out.print(tipousuario.getIdtipousuario());%>"><%out.print(tipousuario.getNombretipo());%></option>
                                <%
                ...
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input type="text" value="<%out.print((error && proceso && usuario != null) ? usuario.getNombreusuario(): "");%>" class="form-control" name="txtnombreusuario_l" required="required" id="txtnombreusuario_l" placeholder="Ej. juancito">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                ...
                <tr class="sm_table_formulariofila">
                    <td>&nbsp;</td>
                    <td colspan="2">
                        <input type="submit" class="form-control" value="Registrar Usuario">
                    </td>
                    <td>&nbsp;</td>
                </tr>                          
            </table>
