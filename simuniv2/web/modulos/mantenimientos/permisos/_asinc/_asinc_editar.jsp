...
<form class="sm_div_formulario" method="POST" id="formulario_actualizacion">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "color:green");%>" >Actualizacion del Permiso</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" value="<%out.print(proceso ? permiso.getNombrePermiso(): "");%>" class="form-control" id="txtnombrepermiso" required="required"  name="txtnombrepermiso">
