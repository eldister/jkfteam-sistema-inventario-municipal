...
<%
    ...
    try {
        tiporeporte = (TipoReporte) request.getAttribute("registro");
...
<form class="sm_div_formulario" method="POST" id="formulario_eliminacion">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "color:green");%>" >Actualizacion de Tipo Reporte</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<%out.print(proceso ? tiporeporte.getNombretiporeporte(): "");%>" class="form-control" id="txtnombretiporeporte" required="required"  name="txtnombretiporeporte">
                        <input type="hidden" value="<%out.print(proceso ? tiporeporte.getIdtiporeporte() : "");%>" name="registro">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
