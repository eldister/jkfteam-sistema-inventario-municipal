...
<%
    ...
    try {
        tiporeporte = (TipoReporte) request.getAttribute("nuevoregistro");
        respuesta = (Respuesta) request.getAttribute("respuesta");
        if (respuesta != null && tiporeporte != null) {
            proceso = true;
        }
...
<form class="sm_div_formulario" method="POST" id="formulario_registro">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>" >Registro de Tipo Reporte</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" value="<%out.print((error && proceso && tiporeporte != null) ? tiporeporte.getNombretiporeporte(): "");%>" class="form-control" id="txtnombretiporeporte" required="required"  name="txtnombretiporeporte">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
