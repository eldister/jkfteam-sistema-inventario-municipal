...
<decorator:decorate filename='../../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Mantenimientos - Estados </decorator:content>    
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        ...
        <script src='<%=request.getContextPath()%>/js/script_paginas/script_mantenimiento_estado.js' charset="utf-8"></script>
    </decorator:content>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <%
            ...
            out.write(new MostradorEstado().Renderizar(listado, paginacion));
        %>
