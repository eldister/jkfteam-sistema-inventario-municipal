...
<%
    ...
    try {
        tipobateria = (TipoBateria) request.getAttribute("registro");
...
<form class="sm_div_formulario" method="POST" id="formulario_eliminacion">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "color:green");%>" >Actualizacion de Tipo Bateria</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<%out.print(proceso ? tipobateria.getNombretipobateria(): "");%>" class="form-control" id="txtnombretipobateria" required="required"  name="txtnombretipobateria">
                        <input type="hidden" value="<%out.print(proceso ? tipobateria.getIdtipobateria() : "");%>" name="registro">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
