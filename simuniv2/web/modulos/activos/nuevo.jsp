<%
  request.setAttribute("permiso_requerido", 2);
%>
...
<%
    ...
    try {
        activo = (Activo) request.getAttribute("registro");
    ...
    try {
        ...
        marca = (tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getMarca() : (tipo_registro != 2 && proceso && activo != null) ? ((ActivoTransporte) activo).getMarca() : "";
        modelo = (tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getModelo() : (tipo_registro != 2 && proceso && activo != null) ? ((ActivoTransporte) activo).getModelo() : "";
        txtdepreciacion = (tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getPorcentajeDepreciacion() + "" : (tipo_registro != 2 && proceso && activo != null) ? ((ActivoTransporte) activo).getPorcentajeDepreciacion() + "" : "";
        txtrescate = (tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getPorcentajeRescate() + "" : (tipo_registro != 2 && proceso && activo != null) ? ((ActivoTransporte) activo).getPorcentajeRescate() + "" : "";

        fechaCompra = (tipo_registro == 1 && proceso && activo != null) ? (UtilidadesServlet.getFechaString(((ActivoArticulo) activo).getFechaAdquisicion())) : (tipo_registro != 2 && proceso && activo != null) ? (UtilidadesServlet.getFechaString(((ActivoTransporte) activo).getFechaAdquisicion())) : "";
        fechaInicioOperacion = (tipo_registro == 1 && proceso && activo != null) ? (UtilidadesServlet.getFechaString(((ActivoArticulo) activo).getFechaInicioOperacion())) : (tipo_registro != 2 && proceso && activo != null) ? (UtilidadesServlet.getFechaString(((ActivoTransporte) activo).getFechaInicio())) : "";
        denominacion = (tipo_registro != 2 && proceso && activo != null) ? activo.getDenominacion() : "Colones";

        if (proceso && tipo_registro != 1 && tipo_registro != 2) {
...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        <script src="<%=request.getContextPath()%>/js/script_paginas/script_nuevo_activo.js" charset="utf-8"></script>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        ...
        <form class="form" enctype="multipart/form-data" id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/activo?proceso=nuevo" method="POST">
            <fieldset id="activos">
                ...
                <div id="registerInformation">
                    <table id="sm_tb_campos">
                            ...
                            <td>
                                <div class="form-group">
                                    <select class="form-control" name="cmbtipoactivo" id="cmbtipoactivo">
                                        ...
                                        %>
                                        <option <%out.print((tipo_registro != 2 && proceso && activo != null && activo.getCodigoTipoActivo() == tipoactivo.getIdtipoactivo()) ? "selected='selected'" : "");%> value="<%out.print(tipoactivo.getIdtipoactivo());%>"><%out.print(tipoactivo.getNombretipoactivo());%></option>
                                        <%
                        ...
                        <tr id="sm_contenedor_propiedades">
                            <td  colspan="4">
                                <fieldset>
                                    <legend>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                *Pulsa el Botón para hacer la actualización
                                            </td>  
                                            <td>
                                                <button class="btn btn-primary">Actualizar Registros</button>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<%out.print((tipo_registro != 2 && proceso && activo != null) ? activo.getPlacaActivo() : "");%>" class="form-control" name="txtplacaactivo" required="required" id="txtplacaactivo" placeholder="Ej. 505550555-112qa">
                                                </div>
                                            </td>                                              
                                            <td >
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="cmbdepartamento" required="required" id="cmbdepartamento">
                                                        ...
                                                        %>
                                                        <option <%out.print((tipo_registro != 2 && proceso && activo != null && activo.getCodigoDepto() == depto.getIddepartamento()) ? "selected='selected'" : "");%> value="<%out.print(depto.getIddepartamento());%>"><%out.print(depto.getNombredepartamento());%></option>
                                                        <%
                                            ...
                                            <td >
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="cmbtipopago" id="cmbtipopago">
                                                        ...
                                                        %>
                                                        <option <%out.print((tipo_registro != 2 && proceso && activo != null && activo.getCodigoTipoPago() == tipopago.getIdtipopago()) ? "selected='selected'" : "");%> value="<%out.print(tipopago.getIdtipopago());%>"><%out.print(tipopago.getNombretipopago());%></option>
                                                        <%
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="cmbestadoactivo" id="cmbestadoactivo">
                                                        ...
                                                        %>
                                                        <option <%out.print((tipo_registro != 2 && proceso && activo != null && activo.getCodigoEstado() == estado.getIdestado()) ? "selected='selected'" : "");%> value="<%out.print(estado.getIdestado());%>"><%out.print(estado.getNombreestado());%></option>
                                                        <%
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group" id="sm_contenedor_activoarticulo">
                                                    ...
                                                    <label id="lbl_inforproveedor"><%out.print((tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getCodigoProveedor() + "Seleccionado" : "No seleccionado");%></label>
                                                    <input type="hidden" required="required" value="<%out.print((tipo_registro == 1 && proceso && activo != null) ? ((ActivoArticulo) activo).getCodigoProveedor() : "");%>" name="hddproveedor" id="hddproveedor">
                                                </div>
                                            </td>                                              
                                        </tr>                                            
                                    </table>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input  value="<%out.print(((tipo_registro != 1 && tipo_registro != 2) && proceso && activo != null) ? ((ActivoTransporte) activo).getPlaca() : "");%>" type="text"  class="form-control" name="txtplacavehiculo" required="required" id="txtplacavehiculo" placeholder="Ej. 505550555-112qa">
                                                </div>
                                            </td>                                              
                                            <td >
                                                <div class="form-group">
                                            ...
                                            <td >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  value="<%out.print(((tipo_registro != 1 && tipo_registro != 2) && proceso && activo != null) ? ((ActivoTransporte) activo).getNumeroChasis() : "");%>" class="form-control" name="txtnumerochasis" required="required" id="txtnumerochasis" placeholder="11122545444">
                                                </div>
                                            </td> 
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtnumeromotor">Número de Motor</label>
                                                    <input type="text"  value="<%out.print(((tipo_registro != 1 && tipo_registro != 2) && proceso && activo != null) ? ((ActivoTransporte) activo).getNumeroMotor() : "");%>" class="form-control" name="txtnumeromotor"  id="txtnumeromotor" placeholder="123486">
                                                </div> 
                                            </td>                                              
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="<%out.print(((tipo_registro != 1 && tipo_registro != 2) && proceso && activo != null) ? ((ActivoTransporte) activo).getCilindros() : "");%>" min="1" class="form-control" name="txtcilindros"  id="txtcilindros" placeholder="Ej. 12">
                                                </div>
                                            </td>   
                                            <td>
                                                <div class="form-group">
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="txtobservacionestecnicas" id="txtobservacionestecnicas" placeholder="Ej. Utiliza Diesel"><%out.print(((tipo_registro != 1 && tipo_registro != 2) && proceso && activo != null) ? ((ActivoTransporte) activo).getObservacionesTecnicas() : "");%></textarea>
                                                </div>
                                            </td>                                              
                                        </tr>                                            
                                    </table>
                            ...
                            <td colspan="5">
                                <fieldset >
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <div class="sm_imgcontainer" id="sm_imgcontainer">&nbsp;</div>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                        ...
                        <tr id="sm_contenedor_controles">
                            ...
                            <td class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
                                    <input type="submit" value="Registrar Activo" class="form-control btn-info">
                                </div>
                            </td>
                            <td  class="btn_controles_sinprocesocontainer">
                                <div class="form-group">
