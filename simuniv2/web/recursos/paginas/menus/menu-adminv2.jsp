...
<html>
    <head>
        ...
        <title>Menú super Administrador</title>
            ...
            <ul>
                ...
                <li class="active has-sub"><a href="#" title="Módulos del sistema">Secciones del Sistema<img src="/simuniv2/recursos/imagenes/menu/circle-down.png" width="20" height="16" style="padding-left: 4px;"></a>
                    <ul>
                        ...
                        <li class="has-sub"><a href="#" title="Despliega el sub-menú">Bajas de activos<img src="/simuniv2/recursos/imagenes/menu/circle-right.png" width="16" height="12" style="float: right;"></a>
                            <ul>
                                <li><a href="%MAINSERVER%/baja?proceso=nuevo" title="Registrar una baja">Registro</a></li>
                                <li><a href="%MAINSERVER%/baja?proceso=listado" title="Lista de bajas">Listado</a></li>
                                <li><a href="%MAINSERVER%/baja?proceso=obtener_solicitudes" title="Lista solicitudes de bajas">Solicitudes</a></li>
                            </ul>
                        </li>  
                        ...
                        <li class="has-sub"><a href="#" title="Despliega el sub-menú">Usuarios<img src="/simuniv2/recursos/imagenes/menu/circle-right.png" width="16" height="12" style="float: right;"></a>
                            <ul>
                                <li><a href="%MAINSERVER%/usuario?proceso=listado" title="Lista de usuarios">Listado</a></li>
                                <li><a href="%MAINSERVER%/usuario?proceso=permisos" title="Lista de usuarios">Permisos</a></li>
                                <li><a href="%MAINSERVER%/usuario?proceso=resetear" title="Lista de usuarios">Reseteo de Clave</a></li>
                            </ul>
                        </li>                        
