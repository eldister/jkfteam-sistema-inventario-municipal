...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Tus solicitudes - Eliminar </decorator:content>    
    ...
    <decorator:content placeholder='sm_div_navegationbarmenuitems'>
        <ol class="breadcrumb">
            ...
            <li class="active">Eliminación Solicitud</li>
        </ol>
    </decorator:content>
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <script src="<%=request.getContextPath()%>/js/script_paginas/script_eliminar_solicitud_baja.js" charset="utf-8"></script>

        <form class="form"  id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/solicitudbaja?proceso=eliminar" method="POST">
            <fieldset id="activos">
                <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>">Eliminación de Solicitud de Baja</legend>
                    ...
                    <table id="sm_tb_campos">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly="readonly" value="<%out.print((solicitudbaja != null) ? (solicitudbaja).getPlacaActivo(): "");%>" required="required" class="form-control" name="txtplacaactivo" id="txtplacaactivo" placeholder="000000">
                                                </div>
                                            </td>                                                                                        
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea readonly="readonly" class="form-control" name="txtrazonbaja" id="txtrazonbaja" placeholder="Ej. Daño Irreparable"><%out.print((solicitudbaja != null) ? solicitudbaja.getMotivo(): "");%></textarea>
                                                    <input type="hidden" name="registro" value="<%out.print((solicitudbaja != null) ? (solicitudbaja).getCodigo(): "");%>">
                                                </div>
                                            </td>                                               
                                        </tr> 
                                        <tr>
                                            <td colspan="3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea readonly="readonly" class="form-control" name="txtobservaciones" id="txtobservaciones" placeholder="Ej. Activo de Segunda"><%out.print((solicitudbaja != null) ? solicitudbaja.getObservaciones() : "");%></textarea>
                                                </div>
                                            </td>                                               
                                        </tr>                                            
                                    </table>                          
                        ...
                        <tr id="sm_contenedor_controles">
                            <td class="btn_controles_sinprocesocontainer" colspan="2">
                                <div class="form-group">
                                    <input type="submit" value="Eliminar Solicitud" class="form-control btn-danger">
                                </div>
                            </td>
                            <%if (proceso) {%>     
                            <td>
                                <div class="form-group">
                                    <button id="sm_btn_iractivos" class="form-control btn-info">Ir a  Solicitud Bajas</button>
                                </div>
                            </td> 
