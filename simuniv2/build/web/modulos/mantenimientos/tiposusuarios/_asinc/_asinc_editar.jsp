        ...
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" value="<%out.print(proceso ? tipousuario.getNombretipo() : "");%>" class="form-control" id="txtnombretipousuario" required="required"  name="txtnombretipousuario">
