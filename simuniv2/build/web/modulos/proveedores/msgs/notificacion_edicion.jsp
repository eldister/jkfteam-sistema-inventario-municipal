...
<decorator:decorate filename='../../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Resultado Modificación de Proveedor </decorator:content>    
    ...
    <decorator:content placeholder='sm_div_navegationbarmenuitems' >
        <ol class="breadcrumb" >
            ...
            <li class="active">Resultado Edición</li>
        </ol>
    </decorator:content>  
        ...
        <div  class="container">
            ...
            <fieldset>
                ...
                <div class="datos_registro">
                    <%if (!error) {%>
                    <p>Los datos actuales de proveedor recién modificado son:</p>
                    <%}%>
