...
function addEventoSubmitFormulario() {
    $("#formulario").submit(function(e) {
        ...
        element = $(this).children().find('#txtfechabaja');
        isformulariovalido = (isformulariovalido && campoValido(element));
        element = $(this).children().find('#txtdocumentorespaldo');
        isformulariovalido = (isformulariovalido && campoValido(element));
        ...
        if (isformulariovalido) {
            if (confirm("Esta a punto de dar de baja un Activo, ¿Desea continuar?")) {
                $(this).unbind();
                $(this).submit();
            }
        }
