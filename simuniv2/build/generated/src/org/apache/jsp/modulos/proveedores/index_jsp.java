...
import simuni.clases.ui.MostradorProveedor;
import simuni.clases.ui.MostradorDepartamento;
        ...
        do {
          ...
          if (_jspx_eval_decorator_content_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              out.write("/css/style_grillageneral.css'>\n");
              out.write("        <script src='");
              out.print(request.getContextPath());
              out.write("/js/script_sm_grillageneral.js' charset=\"utf-8\"></script>\n");
              out.write("                <script src='");
              out.print(request.getContextPath());
              out.write("/js/script_paginas/script_modulo_proveedorindex.js' charset=\"utf-8\"></script>\n");
              out.write("\n");
              out.write(" ");
...
out.print(Recursos.Servers.MAINSERVER);
              ...
              out.write("            <li class=\"active\">Proveedores</li>\n");
              out.write("        </ol>\n");
              out.write("    ");
          ...
          if (_jspx_eval_decorator_content_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            out.write(new MostradorProveedor().Renderizar(listado, paginacion));
              ...
              out.write("                $(\"#sm_div_txtcriteriobusquedagrilla\").val(\"");
out.print(query);
              out.write("\");\n");
              out.write("                iniciarValores(\"");
out.print(mostrar_inactivos);
              out.write("\");\n");
              out.write("                \n");
              out.write("            });\n");
              out.write("        </script>\n");
