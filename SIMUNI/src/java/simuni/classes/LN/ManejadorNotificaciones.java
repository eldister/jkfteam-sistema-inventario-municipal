...
public class ManejadorNotificaciones {
    /**
     * Este método registra las notificaciones recibidas de alguna acción en particular a la base de datos
     * @param notificacion La notificación a registrar
     * @return true en caso de que la operación se halla realizado con éxito o false en caso de que no
     * @since 1.0
     */
     ...
     * usuario en particular y que han sido registradas en la base de datos dependiendo del 
     * usuario que las halla recibido
     * @param idusuario identificación del usuario
     * @return Un ArrayList con todas las notificaciones que ha recibido un usuario en particular o nulo en caso de que no
     * tenga ninguna notificación
     * @since 1.0
     */
     ...
     * usuario en particular y que han sido registrados en la base de datos dependiendo del 
     * usuario que los halla recibido
     * @param idusuario identificación del usuario
     * @return Un ArrayList con todos los mensajes que ha recibido un usuario en particular o nulo en caso de que no
     * tenga ningun mensaje
     * @since 1.0
     */
    ...
    /**
     * Este método obtiene las recientes notificaciones enviadas a un usuario y desactiva las que ha recibido
     * previamente
     * @param idusuario identificador del usuario
     * @return Un ArrayList con las notificaciones recientes enviadas a un usuario en particular o nulo en caso
     * de que no halla tenido ninguna notificación recientemente
     */
    ...
    /**
     * Este método obtiene los recientes mensajes enviados a un usuario y desactiva los que ha recibido
     * previamente
     * @param idusuario identificador del usuario
     * @return Un ArrayList con los mensajes recientes enviados a un usuario en particular o nulo en caso
     * de que no halla tenido ningun mensaje recientemente
     */
