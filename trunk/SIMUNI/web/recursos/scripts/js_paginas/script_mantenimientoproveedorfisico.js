...
function  sm_grilla_proceso_modificaractivo(sm_grilla_item_id) {
    ...
    $.ajax({
        url: "/SIMUNI/modulos/proveedores?proceso=modificacionproveedorfisico&codigoproveedor=" + sm_grilla_item_id,
        cache: false
    })
            .done(function(html) {
...
function  sm_grilla_proceso_eliminaractivo(sm_grilla_item_id) {
    $.ajax({
        type: 'POST',
        url: "/SIMUNI/modulos/proveedores?proceso=bajaproveedorfisicoasinc&codigoproveedor=" + sm_grilla_item_id,
