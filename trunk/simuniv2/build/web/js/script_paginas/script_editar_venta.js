...
function setEventosBotonesFormulario() {
    $("#sm_btn_reporte").click(function(e) {
        e.preventDefault();
        var codigo = "";
        codigo = $("#sm_hidden_codigoventa").val();
...
function addEventoSubmitFormulario() {
    $("#formulario").submit(function(e) {
        ...
        element = $(this).children().find('#txtfechaventa');
        isformulariovalido = (isformulariovalido && campoValido(element));
        element = $(this).children().find('#txtfactura');
        isformulariovalido = (isformulariovalido && campoValido(element));
        element = $(this).children().find('#txtnombrecomprador');
        isformulariovalido = (isformulariovalido && campoValido(element));       

//alert(isformulariovalido);

        if (isformulariovalido) {
            if (confirm("Esta a punto de actualizar una Venta ¿Desea continuar?")) {
                $(this).unbind();
                $(this).submit();
            }
        }
