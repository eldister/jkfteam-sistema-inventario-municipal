    ...
    <body>
        <div id="sm_proveedorindexcontainer">
            <%
                ...
                out.write(new MostradorProveedor().Renderizar_Asinc(listado, paginacion));
            %>
            ...
            <script src='<%=request.getContextPath()%>/js/script_paginas/script_modulo_proveedorindex_asinc.js' charset="utf-8"></script>
