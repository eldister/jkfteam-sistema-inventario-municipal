    ...
    <body>
        <div id="sm_proveedorindexcontainer">
            <%
                ...
                out.write(new MostradorActivo().Renderizar_Asinc(listado, paginacion));
            %>
            ...
            <script src='<%=request.getContextPath()%>/js/script_paginas/script_modulo_activoindex_asinc.js' charset="utf-8"></script>
