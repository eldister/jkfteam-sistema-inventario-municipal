                ...
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input disabled="disabled"  type="text" value="<%out.print((proceso) ? usuario.getCedula() : "");%>" class="form-control" name="txtcedulausuario" required="required" id="txtcedulausuario" placeholder="#-####-#####">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtnombre">Nombre </label>
                            <input disabled="disabled" type="text" value="<%out.print((proceso) ? usuario.getNombre() : "");%>" class="form-control" name="txtnombre"  id="txtnombre" placeholder="Ej. Juan">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtapellido1">1er Apellido</label>
                            <input disabled="disabled" type="text" value="<%out.print((proceso) ? usuario.getApellido1() : "");%>" class="form-control" name="txtapellido1"  id="txtapellido1" placeholder="Ej. Ramírez">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtapellido2">2do Apellido</label>
                            <input disabled="disabled" type="text" value="<%out.print((proceso)? usuario.getApellido2() : "");%>" class="form-control" name="txtapellido2" id="txtapellido2" placeholder="Ej. Ramírez">
                        </div>
                    </td>                    
                </tr> 
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input disabled="disabled" type="email" value="<%out.print((proceso) ? usuario.getEmail(): "");%>" class="form-control" name="txtemail" id="txtemail" placeholder="Ej. ejemplo@ejemplo.com">
                        </div>
                    </td>                    
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="cmbdepartamento">Departamento *</label>
                            <select disabled="disabled" class="form-control" name="cmbdepartamento" required="required" id="cmbdepartamento">
                                <%
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <select  disabled="disabled" class="form-control" name="cmbpuesto" required="required" id="cmbpuesto">
                                <%
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <select disabled="disabled" class="form-control" name="cmbtipousuario" required="required" id="cmbtipousuario">
                                <%
                ...
                <tr class="sm_table_formulariofila">
                    <td>
                        <div class="form-group">
                            ...
                            <input  disabled="disabled" type="text" readonly="readonly" value="<%out.print((proceso) ? usuario.getNombreusuario(): "");%>" class="form-control" name="txtnombreusuario_l" required="required" id="txtnombreusuario_l" placeholder="Ej. juancito">
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <input  disabled="disabled" type="password" value="" class="form-control" name="txtpassword1" required="required" id="txtpassword1" placeholder="********">
                        </div>
                    </td>  
                    <td>
                        <div class="form-group">
                            <label  class="control-label"for="txtpassword2">Repite la Contraseña</label>
                            <input  disabled="disabled" type="password" value="" class="form-control" name="txtpassword2" required="required" id="txtpassword2" placeholder="********">
                        </div>
                    </td>                      
                </tr>
                <tr class="sm_table_formulariofila">
                    <td>&nbsp;</td>
                    <td colspan="2">
                        <input type="submit" class="form-control btn btn-block btn-danger "  value="Eliminar Usuario">
                    </td>
                    <td>&nbsp;</td>
                </tr>                          
            </table>
