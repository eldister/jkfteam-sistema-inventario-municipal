        ...
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" value="<%out.print(proceso ? tipoproveedor.getNombreTipoProveedor(): "");%>" class="form-control" id="txtnombretipoproveedor" required="required"  name="txtnombretipoproveedor">
