...
<%
    ...
    try {
        tipousuario = (TipoUsuario) request.getAttribute("nuevoregistro");
        respuesta = (Respuesta) request.getAttribute("respuesta");
        if (respuesta != null && tipousuario != null) {
            proceso = true;
        }
...
<form class="sm_div_formulario" method="POST" id="formulario_registro">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>" >Registro de Tipo Usuario</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" value="<%out.print((error && proceso && tipousuario != null) ? tipousuario.getNombretipo() : "");%>" class="form-control" id="txtnombretipousuario" required="required"  name="txtnombretipousuario">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
