...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Tus solicitudes - Actualizar </decorator:content>    
    ...
    <decorator:content placeholder='sm_div_navegationbarmenuitems'>
        <ol class="breadcrumb">
            ...
            <li class="active">Actualización de Solicitud</li>
        </ol>
    </decorator:content>
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <script src="<%=request.getContextPath()%>/js/script_paginas/script_editar_solicitud_baja.js" charset="utf-8"></script>

        <form class="form"  id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/solicitudbaja?proceso=actualizar" method="POST">
            <fieldset id="activos">
                <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>">Actualización de solicitud de Baja <small><sup>* Campos requeridos</sup></small></legend>
                    ...
                    <table id="sm_tb_campos">
                        ...
                        <tr id="sm_contenedor_controles">
                            <td class="btn_controles_sinprocesocontainer" colspan="2">
                                <div class="form-group">
                                    <input type="submit" value="Actualizar Solicitud" class="form-control btn-info">
                                </div>
                            </td>
                            <%if (proceso) {%>     
                            <td>
                                <div class="form-group">
                                    <button id="sm_btn_iractivos" class="form-control btn-info">Ir a listado Solicitudes Bajas</button>
                                </div>
                            </td> 
