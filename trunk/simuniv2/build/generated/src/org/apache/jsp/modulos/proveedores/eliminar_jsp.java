...
out.print(Recursos.Servers.MAINSERVER);
              ...
              out.write("            <li><a href=\"");
out.print(Recursos.Servers.MAINSERVER);
              out.write("/\">Modificación de Proveedor</a></li>  \n");
          ...
          if (_jspx_eval_decorator_content_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              out.write("            <fieldset>\n");
              out.write("\n");
              out.write("                <legend>Proceso de eliminación de proveedor</legend>\n");
              out.write("\n");
              out.write("                <legend  class=\"text-danger\">Proceso terminado con errores, no terminado</legend>    \n");
              out.write("                ");
}
              out.write("\n");
              out.write("                <div class=\"datos_registro\">\n");
              out.write("\n");
              out.write("                    <p>Los datos actuales de proveedor recién modificado son:</p>\n");
              out.write("                    ");
}
              out.write("\n");
              out.write("                    <table class=\"sm_datos_registro_table table table-hover \">\n");
              out.write("                        <tr>\n");
              out.write("                            <th>Cédula</th><td>");
out.print(proveedor.getCedula()); 
              out.write("</td>\n");
              out.write("                            <th>Nombre</th><td>");
out.print(proveedor.getNombre()); 
              out.write("</td> \n");
              out.write("                            <th>1er Apellido</th><td>");
out.print(proveedor.getPrimerApellido()); 
              out.write("</td>\n");
              out.write("                            <th>2do Apellido</th><td>");
out.print(proveedor.getSegundoApellido()); 
              out.write("</td>\n");
              out.write("                        </tr>                       \n");
              out.write("                        <tr>\n");
              out.write("                            <th>Telefono</th><td>");
out.print(proveedor.getTelFijo()); 
              out.write("</td>\n");
              out.write("                            <th>Telefono oficina</th><td>");
out.print(proveedor.getTelOfic()); 
              out.write("</td>\n");
              out.write("                            <th>Telefono movil</th><td>");
out.print(proveedor.getTelMovil()); 
              out.write("</td>\n");
              out.write("                            <th>fax</th><td>");
out.print(proveedor.getTelFax()); 
              out.write("</td>\n");
              out.write("                        </tr>       \n");
              out.write("                        <tr>\n");
              out.write("                            <th>Apartado postal</th><td>");
out.print(proveedor.getApartadoPostal()); 
              out.write("</td>\n");
              out.write("                            <th>Email</th><td>");
out.print(proveedor.getEmail()); 
              out.write("</td>\n");
              out.write("                            <th>Web</th><td>");
...
out.print(proveedor.getSegundoApellidoRepresentanteLegal()); 
              ...
              out.write("                        </tr>                           \n");
              out.write("                        <tr>\n");
              out.write("                            <th>Cuenta</th><td colspan=\"2\">");
out.print(proveedor.getNumeroCuenta()); 
              out.write("</td>\n");
              out.write("                            <th>Banco</th><td colspan=\"2\">");
out.print(proveedor.getNombreBanco()); 
              out.write("</td>                            \n");
              out.write("                        </tr>  \n");
              out.write("                        <tr>\n");
              out.write("                            <th>Nombre de la empresa </th><td>");
out.print(proveedor.getNomEmpresa()); 
              out.write("</td>\n");
              out.write("                            <th>Direccion</th><td colspan=\"2\">");
out.print(proveedor.getDirEmpresa()); 
              out.write("</td>\n");
              out.write("                        </tr>                        \n");
              out.write("                        <tr>\n");
              out.write("                            <th>Tipo Proveedor</th><td>");
out.print(proveedor.getTipoProveedor()); 
              out.write("</td>\n");
              out.write("                            <th>Estado Actual</th><td>");
out.print(proveedor.getEstado()); 
              out.write("</td>\n");
              out.write("                            <th>Registro</th><td>");
out.print(proveedor.getFechaRegistro()); 
              out.write("</td>\n");
              out.write("                        </tr>                        \n");
              out.write("                    </table>\n");
              out.write("\n");
              out.write("                    <p class=\"sm_container_reporttext\">\n");
              out.write("                        Este reporte fue generado por el sistema de información SIMUNI, sirve de comprobante para el respaldo de procesos realizados.\n");
              out.write("                    </p>\n");
              out.write("\n");
              out.write("\n");
              out.write("\n");
              ...
              out.write("                    </div>\n");
              out.write("                    <div class=\"sm_container_reportopcionesitem\">\n");
              out.write("                        <button class=\"btn btn-primary\" id=\"sm_btmopcionitem_verdoc\">Ver o agregar Documentos de Proveedor</button>\n");
              out.write("                    </div>    \n");
              out.write("                    <div class=\"sm_container_reportopcionesitem\">\n");
  ...
  private boolean _jspx_meth_decorator_content_1(javax.servlet.jsp.tagext.JspTag _jspx_th_decorator_decorate_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_decorator_content_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("                window.location.assign(SIMUNI_SERVER + \"/proveedor?proceso=listado\");\n");
        out.write("            });\n");
        out.write("            });\n");
        out.write("        </script>        \n");
        out.write("    ");
