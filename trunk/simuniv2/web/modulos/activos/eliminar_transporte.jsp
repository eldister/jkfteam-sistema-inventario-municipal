<%
    request.setAttribute("permiso_requerido", 6);
%>
...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        <script src="<%=request.getContextPath()%>/js/script_paginas/script_eliminar_activo_transporte.js" charset="utf-8"></script>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        ...
        <form class="form" id="formulario" action="<%out.print(Recursos.Servers.MAINSERVER);%>/activo?proceso=eliminar_transporte" method="POST">
            <fieldset id="activos">
                <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>">Eliminación/Baja de Equipo Transporte</legend>
                ...
                <div id="registerInformation">                
                    <table id="sm_tb_campos">
                        ...
                        <tr>
                            ...
                            <td>*<small> Registro qeudará inactivo </small></td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="disabled" value="<%out.print((activo != null) ? activo.getPlacaActivo() : "");%>" class="form-control" name="txtplacaactivo" required="required" id="txtplacaactivo" placeholder="Ej. 505550555-112qa">
                                                </div>
                                            </td>                                              
                                            <td >
                                                <div class="form-group">
                                                    <label  class="control-label"for="cmbdepartamento">Departamento *</label>
                                                    <select class="form-control" name="cmbdepartamento" disabled="disabled" id="cmbdepartamento">
                                                        <%
                                            ...
                                            <td >
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="cmbtipopago" disabled="disabled" id="cmbtipopago">
                                                        <%
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbdenominacion" id="cmbdenominacion">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="disabled" value="<%out.print(marca);%>" class="form-control" name="txtmarca" id="txtmarca" placeholder="Ej. Dell">
                                                </div>
                                            </td>  
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtmodelo">Modelo</label>
                                                    <input type="text" disabled="disabled" value="<%out.print(modelo);%>" class="form-control" name="txtmodelo" id="txtmodelo" placeholder="N5010">
                                                </div>
                                            </td>  
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtdepreciacion">Porcentaje Depreciación</label>
                                                    <input type="number" disabled="disabled" max="100"  value="<%out.print(txtdepreciacion);%>" min="0" class="form-control" name="txtdepreciacion" id="txtdepreciacion" placeholder="10">
                                                </div>
                                            </td>                                              
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtrescate">Porcentaje Rescate</label>
                                                    <input type="number" disabled="disabled"  value="<%out.print(txtrescate);%>"  max="100" min="0" class="form-control" name="txtrescate"  id="txtrescate" placeholder="Ej. 10">
                                                </div>
                                            </td>                                              
                                        </tr>                                        
                                        <tr>
                                            <td colspan="3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" disabled="disabled" name="txtobservaciones" id="txtobservaciones" placeholder="Ej. Activo de Segunda"><%out.print((activo != null) ? activo.getObservaciones() : "");%></textarea>
                                                </div>
                                            </td>                                              
                                        </tr>                                            
                                    </table>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input  value="<%out.print((activo != null) ? ((ActivoTransporte) activo).getPlaca() : "");%>" type="text"  class="form-control" name="txtplacavehiculo" disabled="disabled" id="txtplacavehiculo" placeholder="Ej. 505550555-112qa">
                                                </div>
                                            </td>                                              
                                            <td >
                                                <div class="form-group">
                                                    <label  class="control-label"for="cmbtipovehiculo">Tipo de Vehículo</label>
                                                    <select class="form-control" disabled="disabled" name="cmbtipovehiculo" id="cmbtipovehiculo">
                                            ...
                                            <td >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="disabled"  value="<%out.print((activo != null) ? ((ActivoTransporte) activo).getNumeroChasis() : "");%>" class="form-control" name="txtnumerochasis" required="required" id="txtnumerochasis" placeholder="11122545444">
                                                </div>
                                            </td> 
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtnumeromotor">Número de Motor</label>
                                                    <input type="text" disabled="disabled"  value="<%out.print((activo != null) ? ((ActivoTransporte) activo).getNumeroMotor() : "");%>" class="form-control" name="txtnumeromotor"  id="txtnumeromotor" placeholder="123486">
                                                </div> 
                                            </td>                                              
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" disabled="disabled" value="" class="form-control" name="txtfechafabricacion" id="txtfechafabricacion" placeholder="12-05-2014">
                                                </div>
                                            </td>                                                
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="txtcilindros">Cilindros</label>
                                                    <input type="number" disabled="disabled" value="<%out.print((activo != null) ? ((ActivoTransporte) activo).getCilindros() : "");%>" min="0" class="form-control" name="txtcilindros"  id="txtcilindros" placeholder="Ej. 12">
                                                </div>
                                            </td>   
                                            <td>
                                                <div class="form-group">
                                                    <label  class="control-label"for="cmbtipobateria">Tipo de Baterías</label>
                                                    <select class="form-control" disabled="disabled" name="cmbtipobateria" id="cmbtipobateria">
                                                        <%
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled="disabled" min="0"  value="<%out.print((activo!=null)?activo.getTipoVehiculo():"");%>" min="1" class="form-control" name="txtconsecutivovehiculo"  id="txtconsecutivovehiculo">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="tipollantas_vehiculo">
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantadd" id="cmbtipollantadd">
                                                        <%
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantadi" id="cmbtipollantadi">
                                                        <%
                                                            if (iterador_tipollanta != null && iterador_tipollanta.hasNext()) {
                                                                do {
                                                                    TipoLlanta tipollanta = iterador_tipollanta.next();
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantatd" id="cmbtipollantatd">
                                                        <%
                                                            if (iterador_tipollanta != null && iterador_tipollanta.hasNext()) {
                                                                do {
                                                                    TipoLlanta tipollanta = iterador_tipollanta.next();
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantati" id="cmbtipollantati">
                                                        <%
                                                            if (iterador_tipollanta != null && iterador_tipollanta.hasNext()) {
                                                                do {
                                                                    TipoLlanta tipollanta = iterador_tipollanta.next();
                                        ...
                                        <tr id="tipollantas_moto">
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantad" id="cmbtipollantad">
                                                        <%
                                                            if (iterador_tipollanta != null && iterador_tipollanta.hasNext()) {
                                                                do {
                                                                    TipoLlanta tipollanta = iterador_tipollanta.next();
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" disabled="disabled" name="cmbtipollantat" id="cmbtipollantat">
                                                        <%
                                                            if (iterador_tipollanta != null && iterador_tipollanta.hasNext()) {
                                                                do {
                                                                    TipoLlanta tipollanta = iterador_tipollanta.next();
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" disabled="disabled" name="txtobservacionestecnicas" id="txtobservacionestecnicas" placeholder="Ej. Utiliza Diesel"><%out.print((activo != null) ? ((ActivoTransporte) activo).getObservacionesTecnicas() : "");%></textarea>
                                                </div>
                                            </td>                                              
                                        </tr>                                            
                                    </table>
