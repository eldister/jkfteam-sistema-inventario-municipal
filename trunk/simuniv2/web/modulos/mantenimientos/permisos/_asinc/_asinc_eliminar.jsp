...
<%
    ...
    try {
        permiso = (Permiso) request.getAttribute("registro");
...
<form class="sm_div_formulario" method="POST" id="formulario_eliminacion">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "color:green");%>" >Eliminación de Permiso</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<%out.print(proceso ? permiso.getNombrePermiso(): "");%>" class="form-control" id="txtnombrepermiso" required="required"  name="txtnombrepermiso">
                        <input type="hidden" value="<%out.print(proceso ? permiso.getCodigoPermiso(): "");%>" name="registro">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
