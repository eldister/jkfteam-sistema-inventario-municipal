        ...
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<%out.print(proceso ? tipollanta.getNombretipollanta(): "");%>" class="form-control" id="txtnombretipollanta" required="required"  name="txtnombretipollanta">
