<%
    request.setAttribute("permiso_requerido", 17);
%>
...
<decorator:decorate filename='../../../recursos/paginas/master/masterpage.jsp'>
    <decorator:content placeholder='sm_section_titulodepagina'>SIMUNI | Mantenimientos - Tipos de Bateria </decorator:content>    
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        ...
        <script src='<%=request.getContextPath()%>/js/script_paginas/script_mantenimiento_tipobateria.js' charset="utf-8"></script>
    </decorator:content>
    <decorator:content placeholder='sm_div_navegationbarmenuitems'>
        <ol class="breadcrumb">
            <li><a href="<%out.print(Recursos.Servers.MAINSERVER);%>/">Inicio</a></li>   
            <li class="active">Tipos de Bateria</li>
        </ol>
    </decorator:content>
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <%
            ...
            out.write(new MostradorTipoBateria().Renderizar(listado, paginacion));
        %>
