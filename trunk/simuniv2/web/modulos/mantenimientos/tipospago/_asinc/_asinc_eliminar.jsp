...
<%
    ...
    try {
        tipopago = (TipoPago) request.getAttribute("registro");
        ...
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <input type="text" readonly="readonly" value="<%out.print(proceso ? tipopago.getNombretipopago(): "");%>" class="form-control" id="txtnombretipopago" required="required"  name="txtnombretipopago">
                        <input type="hidden" value="<%out.print(proceso ? tipopago.getIdtipopago() : "");%>" name="registro">
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
