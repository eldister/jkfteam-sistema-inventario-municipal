<%
    request.setAttribute("permiso_requerido", 31);
%>
...
<%
    ...
    try {
        fecharegistro = proveedor.getFechaRegistro().toString();
        fechamodificacion = proveedor.getFechaUltimaModificacion().toString();
    } catch (Exception ex) {
        ex.printStackTrace();
    }
...
<decorator:decorate filename='../../recursos/paginas/master/masterpage.jsp'>
    ...
    <decorator:content placeholder='sm_section_estilosyscriptssectioncontainer'>
        ...
        <script src='<%=request.getContextPath()%>/js/script_paginas/script_editar_proveedor.js' charset="utf-8"></script>
    ...
    <decorator:content placeholder='sm_section_mainsectioncontainer'>
        <form id="formulario" class="form" method="POST" action="<%out.print(Recursos.Servers.MAINSERVER);%>/proveedor?proceso=actualizar">
                ...
                <div id="registerInformation">
                    <table id="sm_tb_campos">
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <label class="control-label" for="txtfecharegistro">Fecha de registro</label>
                                    <input type="text" class="form-control" value="<%out.print(fecharegistro); %>" readonly="readonly" name="txtfecharegistro" id="txtfecharegistro">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label class="control-label" for="txtfecharegistro">Fecha de última modificación</label>
                                    <input type="text" class="form-control" value="<%out.print(fechamodificacion); %>" readonly="readonly" name="txtfecharegistro" id="txtfecharegistro">
                                </div>
                            </td>                            
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly="readonly" title="Este es la cédula que vas a modificar" value="<%out.print(proveedor.getCedula()); %>" class="form-control" name="txtcedulaproveedor" required="required" id="txtcedulaproveedor" placeholder="Ej. 505550555">
                                </div>
                            </td>  
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="submit" value="Actualizar Proveedor" class="form-control btn-info">
                                </div>
                            </td>
                            <td>
                                &nbsp;
