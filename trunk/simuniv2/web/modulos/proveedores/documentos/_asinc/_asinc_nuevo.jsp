...
<%
    ...
    try {
        entregadocumento = (EntregaDocumento) request.getAttribute("nuevoregistro");
...
<form class="sm_div_formulario" method="POST" enctype="multipart/form-data" id="formulario_registro">
    <fieldset id="sm_fs_articulos">
        <legend style="<%out.print((error && proceso) ? "color:red;" : "");%>" >Registro de Entrega de Documentos</legend>
        <div class="sm_form_registroinformacion">
            <table class="sm_tb_campos table">
                ...
                <tr class="sm_table_formulariofila">
                    ...
                    <td>
                        <textarea class="form-control" placeholder="Observaciones" name="txtobservaciones"><%out.print((proceso && entregadocumento != null) ? entregadocumento.getObseravaciones() : "");%></textarea>
                    </td>  
                </tr>  
                <tr class="sm_table_formulariofila">
                    <th>
                        <label class="control-label">Elegir Documento(s)</label>
                    </th>
                    <td>
                ...
                <tr class="sm_table_formulariofila">
                    <td colspan="2">
                        <input type="submit" class="form-control" id="btnsubmitform" value="Registrar">
                    </td>
                </tr>                          
            </table>
        </div>
