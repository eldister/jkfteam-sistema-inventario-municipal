...
/**
 * Esta clase de acceso a datos de <strong>Departamento</strong> se encarga
...
public class ManejadorDatosDepartamento {
     ...
     * @since 1.0
     */
    public String registrarDepartamento(Departamento departamento) throws SQLException {
        String resp = "";
        try {
            Connection con = Conexionmysql.obtenerConexion();
            CallableStatement cs = con.prepareCall("{call simuni_sp_registro_departamento(?,?)}");
            cs.setString(1, departamento.getNombredepartamento());
     ...
     * @since 1.0
     */
    public String modificarDepartamento(Departamento departamento) throws SQLException {
        String resp = "";
        try {
            Connection con = Conexionmysql.obtenerConexion();
            CallableStatement cs = con.prepareCall("{ call simuni_sp_actualizacion_departamento(?,?,?)  }");
            cs.setString(1, departamento.getNombredepartamento());
            cs.setInt(2, departamento.getIddepartamento());
     ...
     * <strong>Departamento</strong> de la base de datos..
     *
     ...
     * @since 1.0
     */
    public String eliminarDepartamento(Departamento departamento) throws SQLException {
        String resp = "";
        try {
            Connection con = Conexionmysql.obtenerConexion();
            CallableStatement cs = con.prepareCall("{ call simuni_sp_eliminacion_departamento(?,?)  }");
     ...
     * @since 1.0
     */
    public ResultSet listadoDepartamento(int desplazamiento, int paginacion) throws SQLException {
        ResultSet resp = null;

        try {
            Connection con = Conexionmysql.obtenerConexion();
            PreparedStatement st = con.prepareCall("SELECT *  FROM  simuni_vw_listado_departamento  LIMIT " + desplazamiento + "," + paginacion + ";");
     ...
     * @since 1.0
     */
    public ResultSet listadoDepartamento() throws SQLException {
        ResultSet resp = null;

        try {
            Connection con = Conexionmysql.obtenerConexion();
            PreparedStatement st = con.prepareCall("SELECT *  FROM  simuni_vw_listado_departamento;");
            resp = st.executeQuery();
    ...
    public Departamento getDepartamento(int codigo) throws SQLException {
        ...
        Connection con = Conexionmysql.obtenerConexion();
        PreparedStatement st = con.prepareCall("{ call simuni_sp_obtener_departamento(?)}", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
        st.setInt(1, codigo);
        ResultSet rs = st.executeQuery();
        if (rs.next()) {
            resp = new Departamento();
            resp.setIddepartamento(rs.getInt(1));
            resp.setNombredepartamento(rs.getString(2));
            rs.close();
        }
        return resp;
    }
    ...
    public int getCantidadFilas(String query) throws SQLException {
        int resp = 0;
        Connection con = Conexionmysql.obtenerConexion();
        PreparedStatement st = con.prepareCall(" {call simuni_sp_obtener_cantidad_redepartamento(?)}");
     ...
     * @since 1.0
     */
    public ResultSet busquedaDepartamento(String query, int desplazamiento, int paginacion) throws SQLException {
        ResultSet resp = null;
        try {
            Connection con = Conexionmysql.obtenerConexion();
            PreparedStatement st = con.prepareCall("{call simuni_sp_busqueda_departamento(?,?,?)}");
            st.setString(1, query);
