 ...
 * @version 1.0
 */
public class AccionesTipoPago extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int registro = 0;
            ManejadorTipoPago mtipopago = new ManejadorTipoPago();
            ...
            switch (getOpcion(request.getParameter("proceso"))) {
                ...
                case Listado:
                    ...
                    resultset = mtipopago.busquedaTipoPago(query, desplazamiento, paginacion);
                    request.setAttribute("listado", resultset);
                    disp = request.getRequestDispatcher("/modulos/mantenimientos/tipospago/index.jsp");
                    request.setAttribute("paginacion", ((int) mtipopago.getCantidadRegistros(query) / paginacion) + 1);
                ...
                case Modificar:
                    ...
                    if (UtilidadesServlet.tryParseInt(request.getParameter("registro"))) {
                        ...
                        TipoPago tipopago = mtipopago.getTipoPago(registro);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int paginacion = 0;//obtener la paginacion y pagina actual  
            String nombretipopago = "";//campo txt
            ManejadorTipoPago mtipopago = new ManejadorTipoPago();
            String query = request.getParameter("query");
            query = query == null ? "" : query;
            ResultSet resultset = null;
            switch (getOpcion(request.getParameter("proceso"))) {
                case Nuevo:
                    ...
                    nuevotipopago.setNombretipopago(nombretipopago);
                    respuesta = mtipopago.registrarTipoPago(nuevotipopago);
                ...
                case Modificar:
                    ...
                    if (UtilidadesServlet.tryParseInt(request.getParameter("registro"))) {
                        ...
                        tipopago.setIdtipopago(registro);
                        tipopago.setNombretipopago(nombretipopago);
                        respuesta = mtipopago.modificarTipoPago(tipopago);
                        request.setAttribute("registro", tipopago);
                        request.setAttribute("respuesta", respuesta);
                        disp = request.getRequestDispatcher("/modulos/mantenimientos/tipospago/_asinc/_asinc_editar.jsp");
                    } else {
                ...
                case Eliminar:
                    if (UtilidadesServlet.tryParseInt(request.getParameter("registro"))) {
                        registro = Integer.parseInt(request.getParameter("registro"));
                        TipoPago tipopago = mtipopago.getTipoPago(registro);
                        respuesta = mtipopago.eliminarTipoPago(tipopago);
                        request.setAttribute("registro", tipopago);
                        request.setAttribute("respuesta", respuesta);
                        disp = request.getRequestDispatcher("/modulos/mantenimientos/tipospago/_asinc/_asinc_eliminar.jsp");
                    }
                ...
                case Query:
                    ...
                    resultset = mtipopago.busquedaTipoPago(query, desplazamiento, paginacion);
                    request.setAttribute("listado", resultset);
                    disp = request.getRequestDispatcher("/modulos/mantenimientos/tipospago/_asinc/_asinc_listar.jsp");
                    request.setAttribute("paginacion", ((int) mtipopago.getCantidadRegistros(query) / paginacion) + 1);
                    break;
                case AccionDefault:
                    npagina = UtilidadesServlet.getNumeroDePagina(request.getParameter("pag"), 0);
